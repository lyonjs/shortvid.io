	...
	return (
		<nav>
			<ul className="flex flex-col justify-between md:flex-row py-5 pb-9">
				<ActiveLink href="/">
					<li className="text-btn-text text-center py-2 px-4 rounded-lg cursor-pointer font-bold hover:scale-105">
						<span>🏠 Home</span>
					</li>
				</ActiveLink>
				<ActiveLink href="/templates/meetup">
					<li className="text-btn-text text-center mt-2 md:mt-0 md:ml-5 py-2 px-4 rounded-lg cursor-pointer font-bold hover:scale-105">
						<span>🗓 Meetup</span>
					</li>
				</ActiveLink>
