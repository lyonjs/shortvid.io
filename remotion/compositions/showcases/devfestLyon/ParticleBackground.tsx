...
export const ParticleBackground = () => {
	...
	const particles = Array.from({length: 10}, (_, i) => {
		const x =
			(i * 1279 + Math.sin(i * 1.618) * 500 + Math.cos(i * 2.414) * 300) % 1280;
		const y =
			(i * 719 + Math.cos(i * 1.272) * 400 + Math.sin(i * 3.141) * 200) % 720;
	...
	const floatingCircles = Array.from({length: 4}, (_, i) => {
		const x =
			(i * 1283 + Math.sin(i * 2.718) * 600 + Math.cos(i * 1.732) * 350) % 1280;
		const y =
			(i * 721 + Math.cos(i * 2.236) * 500 + Math.sin(i * 4.669) * 250) % 720;
	...
	const sparkles = Array.from({length: 5}, (_, i) => {
		const x =
			(i * 1289 + Math.sin(i * 3.141) * 700 + Math.cos(i * 2.828) * 400) % 1280;
		const y =
			(i * 727 + Math.cos(i * 3.464) * 600 + Math.sin(i * 5.236) * 300) % 720;
	...
	const staticParticles = Array.from({length: 5}, (_, i) => {
		const x =
			(i * 1291 + Math.sin(i * 4.669) * 800 + Math.cos(i * 3.464) * 450) % 1280;
		const y =
			(i * 733 + Math.cos(i * 4.123) * 700 + Math.sin(i * 6.283) * 350) % 720;
		...
		const blurAmount =
			i % 4 === 0 ? 2.5 : i % 4 === 1 ? 0.2 : i % 4 === 2 ? 1.2 : 0.6;
