...
export const DevfestNantes = ({ title, speakers }: DefaultProps) => {
  return <AbsoluteFill style={{backgroundColor: 'white', overflow: 'hidden', fontFamily, textTransform: 'uppercase' }}>
    <Sequence>
      <BackgroundFiller
        imageUrl={staticFile('/images/showcases/devfestNantes/fond-visuel-etoiles.png')}
        style={{
          position: 'absolute',
          width: '100%',
          height: '100%',
