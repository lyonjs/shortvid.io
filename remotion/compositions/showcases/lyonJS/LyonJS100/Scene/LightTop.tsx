...
export const LightTop: React.FC = () => {
	...
	const spotOn = (delay: number) => interpolate(frame, [60 + delay, 61 + delay], [0, 0.2], {
	...
	return (
		<g id="lights-top" style={{opacity: 0.7, mixBlendMode: 'hard-light'}}>
			<g id="spot-top">
				<path id="shadow-spot" className="s2296" style={{filter: 'blur(10px)'}}
			...
			<path id="light" className="s2233" style={{filter: 'blur(40px)', opacity: spotOn(0)}}
			...
			<path id="light" className="s2233" style={{filter: 'blur(40px)', opacity: spotOn(10)}}
			...
			<path id="light" className="s2233" style={{filter: 'blur(40px)', opacity: spotOn(20)}}
			...
			<path id="light" className="s2233" style={{filter: 'blur(40px)', opacity: spotOn(30)}}
